<%@ Page Title="Food Catalog — MediCare Admin"
    Language="C#"
...
<asp:Content ID="PageContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="mc-page-header">
    <div>
      <div class="mc-breadcrumb"><i class="fa-solid fa-staff-snake"></i> MediCare <span>/ Food Catalog</span></div>
      <h1>Food Catalog</h1>
  ...
  <asp:Panel ID="pnlForm"
    ...
    <div class="mc-card-header">
      <h3><asp:Label ID="lblFormTitle" runat="server" Text="Add Food Item" /></h3>
    </div>

    <div class="mc-form-grid">
      <div class="mc-form-row"><label>ID</label>           <asp:TextBox ID="txtID"          runat="server" CssClass="mc-input" /></div>
      <div class="mc-form-row"><label>Description</label>  <asp:TextBox ID="txtDescription" runat="server" CssClass="mc-input" /></div>
      ...
      <div class="mc-form-row"><label>Iron</label>         <asp:TextBox ID="txtIron"        runat="server" CssClass="mc-input" /></div>
      <div class="mc-form-row"><label>Potassium</label>    <asp:TextBox ID="txtPotassium"   runat="server" CssClass="mc-input" /></div>
      <div class="mc-form-row"><label>Vitamin C</label>    <asp:TextBox ID="txtVitaminC"    runat="server" CssClass="mc-input" /></div>
      <div class="mc-form-row"><label>Vitamin E</label>    <asp:TextBox ID="txtVitaminE"    runat="server" CssClass="mc-input" /></div>
      <div class="mc-form-row"><label>Vitamin D</label>    <asp:TextBox ID="txtVitaminD"    runat="server" CssClass="mc-input" /></div>
    </div>

    <div class="mc-form-actions">
      <asp:Button ID="btnCancel" runat="server" Text="Cancel"    CssClass="mc-btn mc-btn--outline"  OnClick="btnCancel_Click" />
      <asp:Button ID="btnSave"   runat="server" Text="Save Item" CssClass="mc-btn mc-btn--primary"  OnClick="btnSave_Click"   />
    </div>
